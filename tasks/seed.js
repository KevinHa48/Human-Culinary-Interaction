...
async function main() {
    ...
    const garlicBread = await recipes.create(
        ...
        [
            { food: 'garlic, crushed', units: 'cloves', quantity: 4 },
            { food: 'butter', units: 'tablespoons', quantity: 2 },
            { food: 'extra-virgin olive oil', units: 'tablespoons', quantity: 2 },
            { food: 'grated Parmigiano cheese', units: 'tablespoons', quantity: 3 },
        ]
    );
    ...
    const truffleFries = await recipes.create(
        ...
        [
            ...
            { food: 'Kosher Salt', units: 'teaspoon', quantity: 0.25 },
            { food: 'Parmesean cheese, grated', units: 'tablespoons', quantity: 2 },
            { food: 'Black Truffle Oil', units: 'tablespoons', quantity: 1 },
            { food: 'Truffled Sea Salt', units: 'teaspoons', quantity: 1 },
        ]
    );
    ...
    const guacamole = await recipes.create(
        ...
        [
            { food: 'avocado', units: 'whole', quantity: 3 },
            { food: 'salt', units: 'teaspoon', quantity: 1 },
            { food: 'lime, juiced', units: 'whole', quantity: 1 },
            { food: 'diced onion', units: 'cups', quantity: 0.5 },
            { food: 'plum tomatoes', units: 'whole', quantity: 2 },
            { food: 'minced garlic', units: 'teaspoon', quantity: 1 },
            { food: 'ground cayenne pepper', units: 'pinch', quantity: 1 },
        ]
    );
    ...
    const funnelCake = await recipes.create(
        ...
        [
            { food: 'milk', units: 'cup', quantity: 1 },
            { food: 'egg', units: 'whole', quantity: 1 },
            { food: 'vanilla extract', units: 'teaspoon', quantity: 1.5 },
            { food: 'granulated sugar', units: 'tablespoon', quantity: 1 },
            { food: 'baking powder', units: 'teaspoon', quantity: 0.75 },
            { food: 'salt', units: 'pinch', quantity: 1 },
            { food: 'all purpose flour', units: 'cup', quantity: 0.5 },
            { food: 'powdered sugar', units: 'tablespoons', quantity: 4 },
        ]
    );
    ...
    const pancakes = await recipes.create(
        ...
        [
            { food: 'all-purpose flour', units: 'cup', quantity: 1 },
            { food: 'baking powder', units: 'teaspoon', quantity: 2 },
            { food: 'salt', units: 'teaspoon', quantity: 0.25 },
            { food: 'sugar', units: 'tablespoon', quantity: 1 },
            { food: 'eggs', units: 'whole', quantity: 2 },
            { food: 'milk', units: 'cups', quantity: 2 },
            { food: 'melted and cooled butter', units: 'tablespoons', quantity: 2 },
        ]
    );
    ...
    const spaghett = await recipes.create(
        ...
        [
            ...
            { food: 'beef', units: 'pounds', quantity: 2 },
        ]
    );
    ...
    const pizza = await recipes.create(
        ...
        [
            ...
            { food: 'tomato sauce', units: 'cup', quanity: 2 },
            { food: 'cheese', units: 'ounces', quantity: 16 },
        ]
    );
    ...
    const lasaga = await recipes.create(
        ...
        [
            ...
            { food: 'cheese', units: 'ounces', quantity: 16 },
            { food: 'beef', units: 'pounds', quantity: 2 },
            { food: 'garlic', units: 'clove', quantity: 2 },
        ]
    );
    ...
    const haggis = await recipes.create(
        ...
        [
            ...
            { food: 'sheep tongue', units: 'whole', quantity: 1 },
            { food: 'sheep heart', units: 'whole', quantity: 1 },
        ]
    );
    ...
    const burrito = await recipes.create(
        ...
        [
            ...
            { food: 'cheese', units: 'ounces', quantity: 8 },
            { food: 'lettuce', units: 'ounces', quantity: 8 },
        ]
    );
